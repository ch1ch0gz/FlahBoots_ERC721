...
async function main() {
    ...
    const abi = ["function safeMint(address) external"];
    ...
    const mintTX = await walletContract.populateTransaction.safeMint(funderEOA.address, {
        nonce,
        gasLimit: await walletContract.estimateGas.safeMint(funderEOA.address),
        gasPrice,
        value: 0
    });
